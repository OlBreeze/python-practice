...
class FileProcessor:
    ...
    @staticmethod
    def append_to_file(file_path: str, data: str, encoding: str = 'utf-8') -> None:
        """
        Додає дані до кінця файлу.

        Args:
            file_path (str): Шлях до файлу
            data (str): Дані для додавання
            encoding (str): Кодування файлу (за замовчуванням utf-8)
        ...
        try:
            ...
            raise IOError(f"Помилка при додаванні до файлу {file_path}: {e}")
